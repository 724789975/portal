del application\admin\common.php
mklink /h application\admin\common.php application\api\common.php


del application\admin\model\PlayerModel.php
mklink /h application\admin\model\PlayerModel.php application\api\model\PlayerModel.php
